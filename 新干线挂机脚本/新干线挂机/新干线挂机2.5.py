...
#	print(CurrentStrc)
	...
	for dataline in datalines:
		if '专业课程学分' in dataline:
			cc = re.sub(r'\D', "",dataline)
#				print(dataline)
#				print(re.sub(r'\D', "",dataline))
#	print(datalines)
				
                
	if(ProCredits > int(cc) and CurrentStrc == '专业课程'):
			GoStudy(2)
#		if(OthCredits < 31):
#			GoStudy(2)
#		else:
#			driver.quit()
	...
	for li in li_list:
		...
		#	print(aa.string)
			...
			if(aa.string != None):
				if(re.findall(p1, aa.string) != []):
					continue
		#		print(re.findall(p1, aa.string))
